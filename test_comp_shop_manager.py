...
class TestManager(TestCase):
    ...
    def setUp(self):
        ...
        self.logManager()
        self.manager = ComputerShopManager('BryanCompShop')
    ...
    def test_update_invalid(self):
        ...
        self.assertRaisesRegex(ValueError, "Parts with the same ID does not exist in the inventory.",
                               self.manager.update, self.cpu)
